...
public class RobotContainer {
  ...
  private final Command autoOuttakeCoral =
      Commands.either(
          Commands.sequence(
              arm.setSetpoint(ArmSetpoint.kScoreL3Arm),
              Commands.waitUntil(arm::reachedSetpoint),
              endEffector.outtake(),
              arm.setSetpoint(ArmSetpoint.kArmL3),
              elevator.setSetpoint(ElevatorSetpoint.kElevatorOuttake),
              Commands.waitUntil(elevator::reachedSetpoint),
              elevator.setSetpoint(ElevatorSetpoint.kElevatorIdle),
              arm.setSetpoint(ArmSetpoint.kArmIdle),
              Commands.waitUntil(arm::reachedSetpoint),
              endEffector.stop()),
          Commands.sequence(
              arm.setSetpoint(ArmSetpoint.kScoreL2Arm),
              Commands.waitUntil(arm::reachedSetpoint),
              endEffector.outtake(),
              arm.setSetpoint(ArmSetpoint.kArmL2),
              elevator.setSetpoint(ElevatorSetpoint.kElevatorIdle),
              Commands.waitUntil(elevator::reachedSetpoint),
              arm.setSetpoint(ArmSetpoint.kArmIdle),
              Commands.waitUntil(arm::reachedSetpoint),
  ...
  private final Command autoCanalIntake =
      Commands.sequence(
          arm.setSetpoint(ArmSetpoint.kPushArm),
          Commands.waitUntil(arm::reachedSetpoint),
          canal.intake(),
          elevator.setSetpoint(ElevatorSetpoint.kElevatorHover),
          Commands.waitUntil(elevator::reachedSetpoint),
          arm.setSetpoint(ArmSetpoint.kArmHover),
          Commands.waitUntil(canal::gamePieceDetected),
          canal.slow(),
          Commands.waitSeconds(0.8),
          Commands.parallel(
              elevator.setSetpoint(ElevatorSetpoint.kElevatorIntake), endEffector.intake()),
          Commands.waitUntil(elevator::reachedSetpoint),
          elevator.setSetpoint(ElevatorSetpoint.kElevatorHover),
          Commands.waitUntil(elevator::reachedSetpoint),
          canal.stop(),
  ...
  private final Command autoL2 =
      Commands.either(
          Commands.sequence(
              elevator.setSetpoint(ElevatorSetpoint.kElevatorL2),
              Commands.waitUntil(elevator::reachedSetpoint),
              arm.setSetpoint(ArmSetpoint.kArmL2)),
          Commands.sequence(
              arm.setSetpoint(ArmSetpoint.kPushArm),
  ...
  private final Command autoL3 =
      Commands.either(
          Commands.sequence(
              elevator.setSetpoint(ElevatorSetpoint.kElevatorL3),
              Commands.waitUntil(elevator::reachedSetpoint),
              arm.setSetpoint(ArmSetpoint.kArmL3)),
          Commands.sequence(
              arm.setSetpoint(ArmSetpoint.kPushArm),
  ...
  private final Command pukeOnTrue =
      Commands.either(
          Commands.parallel(
              arm.setSetpoint(ArmSetpoint.kPukeArm), canal.fast(), endEffector.outtake()),
          Commands.parallel(
              arm.setSetpoint(ArmSetpoint.kPushArm), canal.fast(), endEffector.outtake()),
          () -> arm.checkArmHover() && elevator.checkElevatorHover());

  private final Command pukeOnFalse =
      Commands.either(
          Commands.parallel(
              arm.setSetpoint(ArmSetpoint.kArmHover), canal.stop(), endEffector.stop()),
          Commands.sequence(
              canal.stop(),
              endEffector.stop(),
              arm.setSetpoint(ArmSetpoint.kArmIdle),
  ...
  private final Command punchL2Algae =
      Commands.sequence(
          elevator.setSetpoint(ElevatorSetpoint.kOuttakeElevatorAlgae),
          Commands.waitUntil(elevator::reachedSetpoint),
          endEffector.punchAlgae(),
          arm.setSetpoint(ArmSetpoint.kOuttakeArmAlgaeL2));
  ...
  private final Command punchL3Algae =
      Commands.sequence(
          ...
          Commands.waitUntil(elevator::reachedSetpoint),
          endEffector.punchAlgae(),
          arm.setSetpoint(ArmSetpoint.kOuttakeArmAlgaeL3));
  ...
  private final Command resetElevator =
      Commands.sequence(
          elevator.setElevatorResetSpeed(),
          Commands.waitSeconds(1),
          Commands.waitUntil(elevator::elevatorStalled),
